...
Для курсива  * или _ . Например, *курсив* или _курсив_
Для полужирного ** или __ . Например, **полужирный** или __полужирный__

если хотим совместить, то делаем *__ или _** . Например, *__курсив полужирный__*

Для зачеркивания ~. Например, ~~зачеркнуто~~

Для подчеркнутых слов </u>. Например, <u>подчеркнуто</u>
...
![текст если изображение не отобразилось](5555.png)

## Ссылки

Два варианта:

так: <https://gb.ru/lessons/402718/homework>

или так: [ссылка на домашку](https://gb.ru/lessons/402718/homework)

## Таблицы

Извращение с таблицами

|first column|second column|trith column|
|------|------|-|
|текст первой столца|второй столбец|ну и третий|
|nhtnmz cnhjrf| |третья строка|
